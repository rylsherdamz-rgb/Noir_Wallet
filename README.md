...
<video src="assets/noir-demo.mp4" poster="assets/noir-demo-poster.jpg" controls muted width="100%" style="max-width:960px;border-radius:16px;border:1px solid #3A3A3A;box-shadow:0 8px 32px rgba(0,0,0,0.5)">
  <img src="assets/noir-demo-poster.jpg" width="100%" style="max-width:960px;border-radius:16px" alt="Noir Wallet Demo">
</video>
